...
- Fix workspace selection list extending off the screen
- Make workspace selection list adapt to window height
...
- Support new rates fields
- Hide piro compensation field when unused
